...
<body class="bg-success bg-opacity-75">
    <div class="container mt-5 bg-light rounded p-5 col-lg-8">
        ...
        <p>
            ...
            ¿Qué es un <strong>Ataque XSS</strong>?
            <br>
        ...
        <p>
            ...
            Código malicioso
            <br>
            Una vez este <i>keylogger</i> es inyectado en la caja de comentarios del sitio web de la víctima, este registra cada pulsación de tecla que realicen los visitantes del sitio y envía la información a un servidor controlado por el atacante.
            <br>
            <em>
            <?php
            ...
            Las teclas que presionen los visitantes serán registradas en el siguiente archivo <a href="https://proyectosfm1.x10host.com/Ejemplos/AtaqueXSS/web_hacker/keylog.txt" target="_blank"><strong>keylog.txt</strong></a> que se encuentra en la web del atacante.
        </p>
        <hr>
        <a href="https://www.youtube.com/watch?v=w8pwVx_kIig" target="_blank">Fuente</a>
        <div class="row">
            <a class="btn btn-dark mx-auto col-md-4 mt-5" href="web_victima/Front/index.php">Iniciar prueba</a>
        </div>
    </div>
</body>
</html>